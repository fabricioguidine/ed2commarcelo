...
\hypersetup{
    colorlinks,
    debug=false,
    linkcolor=black,  %%% color of tableofcontents, \ref, \footnote, etc
    citecolor=black,  %%% color of \cite
    urlcolor=black,   %%% color of \url e \href
    bookmarksopen=true,
...
% Include pretext (title page)
\include{pretexto}

%----------------------------Optional Dedication--------------
\begin{dedicatoria}
To the Department of Computer Science at UFJF.\\
To the professors who contributed to our learning.
\end{dedicatoria}

%--------Abstract in Portuguese--------------
\resumo{Resumo} Este trabalho apresenta uma análise comparativa de algoritmos de ordenação, implementação de tabelas hash e avaliação de estruturas de dados balanceadas utilizando o dataset Book Depository. Os experimentos avaliam o desempenho dos algoritmos QuickSort e HeapSort, implementam tabelas hash para identificar os autores mais frequentes e comparam o desempenho das árvores Red-Black e B+ nas operações de inserção e busca. Os resultados demonstram as características de cada estrutura de dados e algoritmo, fornecendo insights sobre sua aplicabilidade em diferentes cenários.

\noindent \\ \textbf{Palavras-chave:} Algoritmos de ordenação, Tabelas hash, Árvores balanceadas, Análise de desempenho, Estruturas de dados.

%-----------Abstract in English--------------
\resumo{Abstract} This work presents a comparative analysis of sorting algorithms, implementation of hash tables, and evaluation of balanced data structures using the Book Depository dataset. The experiments evaluate the performance of QuickSort and HeapSort algorithms, implement hash tables to identify the most frequent authors, and compare the performance of Red-Black and B+ trees in insertion and search operations. The results demonstrate the characteristics of each data structure and algorithm, providing insights into their applicability in different scenarios.

\noindent \\ \textbf{Keywords:} Sorting algorithms, Hash tables, Balanced trees, Performance analysis, Data structures.

%-----------------------------------------------------------
\agradecimento{Acknowledgments} \indent\indent 
To everyone who contributed to the development of this work.\\
To the Department of Computer Science at UFJF for support and guidance.\\
To the professors of DCC012 - Data Structures II for their teachings.

%---------------------- Optional Epigraph--------------
\begin{epigrafe}
``Continuous learning is the key to success in Computer Science.''\\
\hfill Adapted
\end{epigrafe}
